...
function authenticate(helper, paramsValues, credentials) {
    ...
    var request = {
        ...
        uri: new URI(url, false), // http://testfire.net/login.jsp || /doLogin
        body: requestBody, // uid=admin&passw=admin	|| uid=admin&passw=admin&btnSubmit=Login
        contentType: formEncoded, // "text/html; charset=utf-8"	|| application/x-www-form-urlencoded
        cookies: null,
        authHeader: null,
        referer: null,
    };
